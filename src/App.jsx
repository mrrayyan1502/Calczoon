...
const RetirementPlanningGuide = lazy(() => import('@/pages/blog/RetirementPlanningGuide'));
const FreelancerTaxGuide = lazy(() => import('@/pages/blog/FreelancerTaxGuide'));
const WaterIntakeGuide = lazy(() => import('@/pages/blog/WaterIntakeGuide'));
const DebtToIncomeGuide = lazy(() => import('@/pages/blog/DebtToIncomeGuide'));
const CryptoProfitGuide = lazy(() => import('@/pages/blog/CryptoProfitGuide'));
const PregnancyHealthGuide = lazy(() => import('@/pages/blog/PregnancyHealthGuide'));
const VatTaxGuide = lazy(() => import('@/pages/blog/VatTaxGuide'));
const DiscountShoppingGuide = lazy(() => import('@/pages/blog/DiscountShoppingGuide'));
const InvestmentRoiGuide = lazy(() => import('@/pages/blog/InvestmentRoiGuide'));
const SalaryNegotiationGuide = lazy(() => import('@/pages/blog/SalaryNegotiationGuide'));
