...
const links = {
  ...
  bmi: [
    ...
    { name: 'Fitness Tracker', url: 'https://amzn.to/3R4fit', desc: 'Track steps, heart rate & calories' },
  ],
  tdee: [
    { name: 'Kitchen Food Scale', url: 'https://amzn.to/3R4food', desc: 'Accurate food scale for macro tracking' },
    { name: 'Meal Prep Containers', url: 'https://amzn.to/3R4meal', desc: 'Portion control containers for diet planning' },
  ],
  compound: [
  ...
  water: [
    ...
    { name: 'Water Tracking App', url: 'https://amzn.to/3R4app', desc: 'Top hydration tracking apps' },
  ],
  savings: [
