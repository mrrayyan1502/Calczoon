            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm mt-1">If you opt-in, we use Google Analytics to collect anonymous, aggregated traffic data (e.g. pageviews, button clicks, country level geography). This assists us in optimizing our tool performance. Google Analytics does not track PII or any data values entered into the calculators. IP addresses are anonymized automatically by Google before storage.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm mt-1">If you have any questions or concerns about this Privacy Policy, or want to exercise your data rights, please contact us via our <Link to="/contact" className="text-emerald-400 hover:underline font-semibold">Contact Page</Link>.</p>
                </div>
              </div>
            </div>
          </CardContent>
