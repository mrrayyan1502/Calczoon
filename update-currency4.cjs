...
files.forEach(file => {
    ...
    // Exact string replacement for the ternary operator. Use a function for the replacement
    // so that the '$' character inside newGetCurrencySymbol is NOT treated as a regex replacement token!
